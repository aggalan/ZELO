...
export const useUsersStore = defineStore('users', () => {
  const users = ref([
    {id: 1, alias: Math.random().toString(36).substring(2, 10), email: 'nicolaskoron@gmail.com', passwordHash: 'bmNvZGFkb3M=', name: 'Nicolas', cbu: 10 , contacts: [{name: 'Santiago',email: 'smaffeo@itba.edu.ar',  cbu: 20}, {name: 'Juan', email: 'juan@itba.edu.ar', cbu: 30}]},
